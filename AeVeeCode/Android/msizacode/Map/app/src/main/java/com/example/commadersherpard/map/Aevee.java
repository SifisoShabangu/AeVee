...
public class Aevee
{
    ...
    static public String [] ProductList={"LCD HD SAMSUNG TV","XBOX","Braai Worse","5 Piece Office Set","4 cusins wine"};
    static public double [] ProductList1Price={10000.00,6999.00,39.99,12000.00,149.00};
    static public String [] ProductList2={"Zimba","Pants","Shoes","Socks","Dress"};
    static public double [] ProductList2Price={150.00,45.00,300.99,50.99,300.00};
    static public String [] ShopList={"GAME","PicknPay"};
